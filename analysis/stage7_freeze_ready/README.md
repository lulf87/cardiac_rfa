...
Freeze patch updates:
- Figure 3 uses protocol-specific markers (o / s / ^) in both curves and shared legend.
- Figure 6 omission note removed from the graphic; place that sentence in the figure caption instead.
