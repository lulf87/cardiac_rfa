...
def make_fig1(outbase: Path):
    ...
    ax0.text(1.2, 6.23, "Blood pool", fontsize=10)
    ...
    ax0.text(1.2, 2.05, "Bottom thermal buffer", fontsize=10)
    ...
    ax0.text(6.95, 6.55, "Top cooling (h)", fontsize=9.5, color="#537DA7")
